...
fluidRow(column(12,
  mainPanel(width=12,
    h3("fetchDiffCorrNetwork"),
    p("Compute a differential correlation network, see ",
      a(href='http://kwanjeeraw.github.io/grinn/fetchdiffcorr.html',target='_blank','here'),' for argument details.'
    )
  )#end mainPanel
)),
wellPanel(
